...
CREATE TABLE IF NOT EXISTS public.search_history (
  search_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  account_id integer,
  ...
  CONSTRAINT fk_account FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON UPDATE CASCADE ON DELETE
  SET NULL
);
-- Create index for better query performance
CREATE INDEX IF NOT EXISTS idx_search_history_criteria ON public.search_history(search_criteria);
